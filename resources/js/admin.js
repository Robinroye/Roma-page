export function admin() {
    return {
        ...
        saveCompletion(pedido, detalle, checked) {
            localStorage.setItem(`pedido_${pedido}_detalle_${detalle}`, JSON.stringify(checked));
        },
        checkCompletion(pedido, detalle) {
            return JSON.parse(localStorage.getItem(`pedido_${pedido}_detalle_${detalle}`)) || false;
        },
