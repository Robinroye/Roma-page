                    ...
                    <div x-data="{editing: true}">
                            ...
                            <div class="d-flex align-items-center border-bottom py-3" x-data="{cantidadVariedad: producto.cantidad}">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mb-1">
                                        ...
                                        <b> x 
                                            <input type="number" class="form-control d-inline w-25 text-center" min="1" x-model="cantidadVariedad" @input="guardarEdiciones(index, 'variedades')">
                                        </b>
                                    </h6>
                                    <p class="small text-muted" x-text="producto.detalles"></p>
                                    <p class="fw-bold mb-0">$<span x-text="producto.precio * cantidadVariedad"></span></p>
                                </div>
                            ...
                            <div class="d-flex flex-column border-bottom py-3" x-data="{cantidadImpresion: producto.cantidad}">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1">
                                            <span>Impresión</span>
                                            <b> x 
                                                <input type="number" class="form-control d-inline w-25 text-center" min="1" x-model="cantidadImpresion" @input="guardarEdiciones(index, 'impresion')">
                                            </b>
                                        </h6>
                                        <p class="small text-muted" x-text="producto.detalles"></p>
                                        <p class="fw-bold mb-0">$<span x-text="producto.precio * cantidadImpresion"></span></p>
                                    </div>
                                    <button class="btn btn-transparent btn-sm" @click="eliminarDelCarrito(index)">
                                        <i class="fas fa-trash-alt"></i>
                                    </button>
                                ...
                                <div x-bind:id="'accordion'+producto.id" class="accordion w-100 mt-2 collapsed">
                                    <div class="accordion-item">
                                        ...
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" x-bind:data-bs-target="'#accordion'+producto.id+'_item'" aria-expanded="false" aria-controls="collapseOne">
                                            Detalles
                                        </button>
                                        </h2>
                                        <div class="accordion-collapse collapse" x-bind:id="'accordion'+producto.id+'_item'" aria-labelledby="headingOne" x-bind:data-bs-parent="'#accordion'+producto.id">
                                        <div class="accordion-body">
                                            <p><strong>Papel: </strong><span x-text="producto.impresion_papel"></span></p>
                                            <p><strong>Color: </strong><span x-text="producto.impresion_color"></span></p>
                                            <p><strong>Caras: </strong><span x-text="producto.impresion_caras"></span></p>
                                            <p><strong>Paginas a imprimir: </strong><span x-text="producto.impresion_paginas_a_imprimir"></span></p>
                                            <p><strong>Paginas: </strong><span x-text="producto.impresion_paginas_totales"></span></p>
                                        </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <template x-if="producto.tipo === 'giro'">
                            <div class="d-flex flex-column border-bottom py-3" x-data="calculadora()">
                                <div class="d-flex align-items-center" x-init="bss= producto.monto_bss; dolares= producto.monto_dolares; cop= producto.monto_cop">
                                    <img :src="producto.imagen" class="img-thumbnail me-3" style="width: 80px; height: 80px; object-fit: cover;">
                                    <div class="flex-grow-1">
                                ...
                                <div x-bind:id="'accordion'+producto.id" class="accordion w-100 mt-2 collapsed">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" x-bind:data-bs-target="'#accordion'+producto.id+'_item'" aria-expanded="true" aria-controls="collapseOne">
                                            Detalles
                                        </button>
                                        </h2>
                                        <div class="accordion-collapse collapse" x-bind:id="'accordion'+producto.id+'_item'" aria-labelledby="headingOne" x-bind:data-bs-parent="'#accordion'+producto.id">
                                        <div class="accordion-body">
                                            <p><strong>Titular: </strong><span x-text="producto.nombre_titular"></span></p>
                                            <p><strong>Tipo de Documento: </strong><span x-text="producto.tipo_documento"></span></p>
                                            <p><strong>Cuenta: </strong><span x-text="producto.numero_cuenta"></span></p>
                                            <p><strong>Pago Móvil: </strong><span x-text="producto.pago_movil"></span></span></p>
                                            <div >
                                                <p><strong>BSS: </strong><input type="number" class="form-control d-inline w-25 text-center" min="1" x-model.number="bss" @input="guardarEdiciones(index, 'giro', 'bss')"></span></p>
                                                <p><strong>Dólares: </strong><input type="number" class="form-control d-inline w-25 text-center" min="1" x-model.number="dolares" @input="guardarEdiciones(index, 'giro', 'dolares')"></span></p>
                                                <p><strong>Pesos Colombianos: </strong><input type="number" class="form-control d-inline w-25 text-center" min="1" x-model.number="cop" @input="guardarEdiciones(index, 'giro', 'cop')"></span></p>
                                            </div>
